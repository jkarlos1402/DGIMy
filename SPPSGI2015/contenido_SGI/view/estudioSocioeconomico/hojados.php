...
<div class="form-group">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h1 class="panel-title"><strong> HOJA 2</strong></h1>
        </div>
    </div>
    ...
    <div class="form-group col-md-10" id="tipcob1">
        ...
        <div class="col-md-2">
            <select id="tipoCobertura" name="tipoCobertura1" class="form-control bnc am-as obligatorioHoja2 obligatorio">
            </select>
        </div>
    ...
    <div class="form-group col-md-10">
        ...
        <div class="col-md-3">
            <select id="tipLoc" name="tipLoc" class="form-control bnc am-as obligatorioHoja2 obligatorio"></select>                            
        </div>
    </div>
    <div class="form-group col-md-10">
        <label for="coord" class="col-lg-3 control-label"><font color="red" size="7">* </font>Coordenadas: </label>
        <div class="col-lg-2">
            <select id="coor" name="coor" class="form-control bnc am-as obligatorioHoja2 obligatorio">
