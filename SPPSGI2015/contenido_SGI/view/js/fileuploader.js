...
qq.extend(qq.UploadHandlerXhr.prototype, {
    ...
    _onComplete: function(id, xhr){
        ...
        if (xhr.status == 200){
            ...
            var valurl = xhr.responseText;
            valurl = valurl.replace("success","");
            valurl = valurl.replace("true","");
            valurl = valurl.replace("ruta","");
            valurl = valurl.replace(/,/g, "");
            valurl = valurl.replace(/"/g, "");
            valurl = valurl.replace(/:/g, "");
            valurl = valurl.replace("{","");
            valurl = valurl.replace("}","");
            $("#rut").val(valurl);
            muestraThumb("imagenes/"+valurl);
